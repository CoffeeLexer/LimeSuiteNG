    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    chkPD_CP_CGEN =
        new wxCheckBox(sbSizer66->GetStaticBox(), ID_PD_CP_CGEN, wxT("Charge pump"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_CP_CGEN->SetToolTip(wxT("Power down for Charge Pump"));

    sbSizer66->Add(chkPD_CP_CGEN, 0, flags, 0);

    chkPD_FDIV_FB_CGEN = new wxCheckBox(
        sbSizer66->GetStaticBox(), ID_PD_FDIV_FB_CGEN, wxT("Feedback frequency divider"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_FDIV_FB_CGEN->SetToolTip(wxT("Power down for feedback frequency divider"));

    sbSizer66->Add(chkPD_FDIV_FB_CGEN, 0, flags, 0);

    chkPD_FDIV_O_CGEN =
        new wxCheckBox(sbSizer66->GetStaticBox(), ID_PD_FDIV_O_CGEN, wxT("Frequency divider"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkPD_VCO_COMP_CGEN =
        new wxCheckBox(sbSizer66->GetStaticBox(), ID_PD_VCO_COMP_CGEN, wxT("VCO comparator"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_VCO_COMP_CGEN->SetToolTip(wxT("Power down for VCO comparator"));

    sbSizer66->Add(chkPD_VCO_COMP_CGEN, 0, flags, 0);

    chkEN_G_CGEN =
        new wxCheckBox(sbSizer66->GetStaticBox(), ID_EN_G_CGEN, wxT("Enable CLKGEN module"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkRESET_N_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_RESET_N_CGEN, wxT("Pulse used in start-up to reset"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_COARSE_CKLGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_EN_COARSE_CKLGEN, wxT("Enable coarse tuning block"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_COARSE_CKLGEN->SetToolTip(wxT("Enable signal for coarse tuning block"));

    fgSizer81->Add(chkEN_COARSE_CKLGEN, 0, flags, 0);

    chkEN_INTONLY_SDM_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_EN_INTONLY_SDM_CGEN, wxT("Enable INTEGER-N mode"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_INTONLY_SDM_CGEN->SetToolTip(wxT("Enables INTEGER-N mode of the SX "));

    fgSizer81->Add(chkEN_INTONLY_SDM_CGEN, 0, flags, 0);

    chkEN_SDM_CLK_CGEN =
        new wxCheckBox(sbSizer65->GetStaticBox(), ID_EN_SDM_CLK_CGEN, wxT("Enable SDM clock"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_SDM_CLK_CGEN->SetToolTip(
        wxT("Enables/Disables SDM clock. In INT-N mode or for noise testing, SDM clock can be disabled"));

    fgSizer81->Add(chkEN_SDM_CLK_CGEN, 0, flags, 0);

    chkREV_SDMCLK_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_REV_SDMCLK_CGEN, wxT("Reverse SDM clock"), wxDefaultPosition, wxDefaultSize, 0);
    chkREV_SDMCLK_CGEN->SetToolTip(wxT("Reverses the SDM clock"));

    fgSizer81->Add(chkREV_SDMCLK_CGEN, 0, flags, 0);

    chkSX_DITHER_EN_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_SX_DITHER_EN_CGEN, wxT("Enable dithering in SDM"), wxDefaultPosition, wxDefaultSize, 0);
    chkSX_DITHER_EN_CGEN->SetToolTip(wxT("Enabled dithering in SDM"));

    fgSizer81->Add(chkSX_DITHER_EN_CGEN, 0, flags, 0);

    chkREV_CLKDAC_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_REV_CLKDAC_CGEN, wxT("Invert DAC F_CLKL"), wxDefaultPosition, wxDefaultSize, 0);
    chkREV_CLKDAC_CGEN->SetToolTip(wxT("Inverts the clock F_CLKL"));

    fgSizer81->Add(chkREV_CLKDAC_CGEN, 0, flags, 0);

    chkREV_CLKADC_CGEN = new wxCheckBox(
        sbSizer65->GetStaticBox(), ID_REV_CLKADC_CGEN, wxT("Invert ADC F_CLKL"), wxDefaultPosition, wxDefaultSize, 0);
    chkREV_CLKADC_CGEN->SetToolTip(wxT("Inverts the clock F_CLKL"));

    fgSizer81->Add(chkREV_CLKADC_CGEN, 0, flags, 0);

    chkREVPH_PFD_CGEN =
        new wxCheckBox(sbSizer65->GetStaticBox(), ID_REVPH_PFD_CGEN, wxT("REVPH_PFD_CGEN"), wxDefaultPosition, wxDefaultSize, 0);
    chkREVPH_PFD_CGEN->SetToolTip(wxT("Reverse the pulses of PFD. It can be used to reverse the polarity of the PLL loop (positive "
                                      "feedback to negative feedback)"));

    fgSizer81->Add(chkREVPH_PFD_CGEN, 0, flags, 0);

    chkCOARSE_START_CGEN = new wxCheckBox(sbSizer65->GetStaticBox(),
        ID_COARSE_START_CGEN,
        wxT("Signal coarse tuning algorithm"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    rgrSEL_SDMCLK_CGEN = new wxRadioBox(this,
        ID_SEL_SDMCLK_CGEN,
        wxT("Output for SDM"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrSEL_SDMCLK_CGENNChoices,
        rgrSEL_SDMCLK_CGENChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    cmbEN_ADCCLKH_CLKGN = new wxRadioBox(this,
        ID_EN_ADCCLKH_CLKGN,
        wxT("FCLKH to"),
        wxDefaultPosition,
        wxDefaultSize,
        cmbEN_ADCCLKH_CLKGNNChoices,
        cmbEN_ADCCLKH_CLKGNChoices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    m_staticText369 =
        new wxStaticText(sbSizer140->GetStaticBox(), wxID_ANY, wxT("RxTSP (MHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText367 =
        new wxStaticText(sbSizer140->GetStaticBox(), wxID_ANY, wxT("TxTSP (MHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT10 =
        new wxStaticText(sbSizer70->GetStaticBox(), wxID_ANY, wxT("CLK_H (MHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT10->Wrap(-1);
    fgSizer89->Add(ID_STATICTEXT10, 1, wxALIGN_CENTER_HORIZONTAL, 5);

    ID_STATICTEXT18 =
        new wxStaticText(sbSizer70->GetStaticBox(), wxID_ANY, wxT("CLKH_OV_CLKL"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT18->Wrap(-1);
    fgSizer89->Add(ID_STATICTEXT18, 1, wxALIGN_CENTER_HORIZONTAL, 10);

    ID_STATICTEXT3 =
        new wxStaticText(sbSizer70->GetStaticBox(), wxID_ANY, wxT("CLK_L (MHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    txtFrequencyCLKL =
        new wxTextCtrl(sbSizer70->GetStaticBox(), wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(48, -1), wxTE_READONLY);
    ...
    rxPhase = new wxSpinCtrl(
        sbSizer70->GetStaticBox(), ID_GFIR1_N_TXTSP, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 360, 120);
    ...
    lblVCO_CMPHO_CGEN =
        new wxStaticText(sbSizer76->GetStaticBox(), ID_VCO_CMPHO_CGEN, wxT("???"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    lblVCO_CMPLO_CGEN =
        new wxStaticText(sbSizer76->GetStaticBox(), ID_VCO_CMPLO_CGEN, wxT("???"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    lblCOARSE_STEPDONE_CGEN =
        new wxStaticText(sbSizer139->GetStaticBox(), ID_COARSE_STEPDONE_CGEN, wxT("???"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    lblCOARSEPLL_COMPO_CGEN =
        new wxStaticText(sbSizer139->GetStaticBox(), ID_COARSEPLL_COMPO_CGEN, wxT("???"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT20 =
        new wxStaticText(sbSizer67->GetStaticBox(), wxID_ANY, wxT("CSW_VCO_CGEN"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT20->Wrap(-1);
    fgSizer85->Add(ID_STATICTEXT20, 1, wxALIGN_LEFT | wxALIGN_BOTTOM, 5);

    cmbCSW_VCO_CGEN = new NumericSlider(
        sbSizer67->GetStaticBox(), ID_CSW_VCO_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 255, 0);
    fgSizer85->Add(cmbCSW_VCO_CGEN, 0, wxEXPAND, 5);

    ID_STATICTEXT9 =
        new wxStaticText(sbSizer67->GetStaticBox(), wxID_ANY, wxT("Scales VCO bias current"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT9->Wrap(-1);
    fgSizer85->Add(ID_STATICTEXT9, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbICT_VCO_CGEN = new NumericSlider(
    ...
    ID_STATICTEXT16 =
        new wxStaticText(sbSizer69->GetStaticBox(), wxID_ANY, wxT("Offset current"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT16->Wrap(-1);
    fgSizer87->Add(ID_STATICTEXT16, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbIOFFSET_CP_CGEN = new NumericSlider(
        sbSizer69->GetStaticBox(), ID_IOFFSET_CP_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 63, 0);
    cmbIOFFSET_CP_CGEN->SetMinSize(wxSize(48, -1));

    fgSizer87->Add(cmbIOFFSET_CP_CGEN, 1, wxEXPAND, 5);

    ID_STATICTEXT17 =
        new wxStaticText(sbSizer69->GetStaticBox(), wxID_ANY, wxT("Pulse current"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT17->Wrap(-1);
    fgSizer87->Add(ID_STATICTEXT17, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbIPULSE_CP_CGEN = new NumericSlider(
        sbSizer69->GetStaticBox(), ID_IPULSE_CP_CGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 63, 0);
...
void lms7002_pnlCLKGEN_view::UpdateGUI()
{
    ...
    value = ReadParam(LMS7param(FRAC_SDM_CGEN_LSB));
    fracValue |= value;
    lblFRAC_SDM_CGEN->SetLabel(std::to_string(fracValue));
    value = ReadParam(LMS7param(DIV_OUTCH_CGEN));
...
{
    uint16_t param;
    param = ReadParam(LMS7param(VCO_CMPHO_CGEN));

    lblVCO_CMPHO_CGEN->SetLabel(std::to_string(param));
    if (param == 1)
        lblVCO_CMPHO_CGEN->SetBackgroundColour(*wxGREEN);
    else
        lblVCO_CMPHO_CGEN->SetBackgroundColour(*wxRED);

    param = ReadParam(LMS7param(VCO_CMPLO_CGEN));

    lblVCO_CMPLO_CGEN->SetLabel(std::to_string(param));
    if (param == 0)
...
{
    uint16_t param;
    param = ReadParam(LMS7param(COARSE_STEPDONE));
    lblCOARSE_STEPDONE_CGEN->SetLabel(std::to_string(param));
    param = ReadParam(LMS7param(COARSEPLL_COMPO_CGEN));
    lblCOARSEPLL_COMPO_CGEN->SetLabel(std::to_string(param));
}
